      ...
      <div class="container-fluid">
         ...
         <div id="detail" class="row m-3">
            ...
            <ul>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="item">1:1 문의 관리</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                       
                        <span class="item">리뷰 관리</span>
                    </a>
                </li>
            ...
            <div class=" col-12 col-md-12 col-lg-5 ">
               ...
               <button style="width:150px;height:70px;margin:auto; display:block "type="button"
         ...
         <div id="item-info" class="d-none d-md-none d-lg-inline col-lg-4 m-3">
               <div class= "item-detail border " style="height:100%">
                  <div class = "mt-3 mx-4 " style="font-size:200%">  <input type="text" class="form-control" placeholder="상품명을 입력해주세요" id="title"> </div>
                  <div class = "mb-3 mx-4"> <input type="text" class="form-control" placeholder="상품코드를 입력해주세요" id="title"></div>
                  <div class="flex-container">
                  <div class = "mx-5" style="flex-grow: 5;text-align : center"><h4>판매가</h4>  </div>
                  <div class = "mx-4" style=" flex-grow: 5;text-align : center"> <input type="text" class="form-control" placeholder="가격을 입력해주세요" id="title"></div>
                  ...
                  <div class = "colorRadio" style="height:30px">
                         ...
                         <input id="color1-1" name="color1" type="checkbox" value="blue" checked="checked">
               			 <label for="color1-1" class="border rounded-circle " style="background-color:steelblue;  "></label>
                         <input id="color1-2" name="color1" type="checkbox" value="black" >
                         <label for="color1-2" class="border rounded-circle " style="background-color:black;  "></label>
                         <input id="color1-3" name="color1" type="checkbox" value="white" >
         ...
         <div class="row">
            <div class = "col-1"></div>
            <div class = "col-10"> <button style="width:150px;height:70px;margin:auto; display:block "type="button"
                class="btn btn-secondary"
                        >광고사진등록</button></div>
            <div class = "col-1"></div>
