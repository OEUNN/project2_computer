				...
				<div id="icon" class=" col-2">
					<div class = "mt-3">
						<a href="../user/mypage.html">
							<img src="../images/basket.png" style="width:40px;height:40px;" />
						</a>
					</div>
					<!-- 아이콘안 메뉴 -->
					<div class = "mt-3 ml-5">
	                	...
	                	<label for="menuBtn" class="labelBtn" onclick="">
	                		<img src="../images/Human icon.png" style="width:40px;height:40px;" />
	                	</label>
	                	<ul class="submenu" style="width:90px;">
	                    	<li ><a href="../user/join.html">회원가입</a></li>
	                    	<li ><a href="../user/loginForm.html">로그인</a></li>
	                    	<li ><a href="../user/mypage.html">마이페이지</a></li>
	                	</ul>
					</div>
				</div>
				...
				<div  class="col-lg-8 col-12 p-5" style="height:550px;">
					...
					<div id="search" class="row mt-5">
						<div class="col-2 mr-2">
							<img src="../images/search.png" style="width:35px;height:35px" />
						</div>
						<div class="col" >
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div style="width:250px;height:250px;">
								<img src="../images/pngwing.com.png" alt="image Error"/>
							</div>
						</div>
						<div class="row">
							<div>
