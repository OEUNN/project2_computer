...
<%@ include file="/resources/css/productDetail.css"%>
...
<div id="detail" class="row">
	...
	<div class=" col-12 col-md-12 col-lg-6 ">
		<div class="pt-4" style="width: 100%">
			<img src="${pageContext.request.contextPath}/resources/images/monitor3_d.png" />
		</div>
	</div>
	<!-- 상품 디테일 카드 -->
	<div id="item-info" class="d-none d-md-none d-lg-inline col-lg-4 m-4">
		...
		<div class="item-detail border " style="height: 100%">
			...
			<div class="flex-container-button mt-4 ">
				<div style="flex-grow: 5" class="w-btn w-btn-indigo mx-1"
					data-toggle="modal" data-target="#myModal">장바구니</div>
				<div style="flex-grow: 5" class="w-btn w-btn-indigo mx-1">구매하기
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-1"></div>
	<div class="col-10">
		<img src="${pageContext.request.contextPath}/resources/images/ad.png" /><img
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">장바구니에 담겼습니다</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="#">
					...
					<div>
						<button type="button" class="btn btn-secondary">사진 업로드</button>
					</div>
					<br />
					<div class="qnaNoti">
			...
			<!-- Modal footer -->
			<div class="modal-footer">
				<button type="submit" onClick="../product/ProductDetailController"
